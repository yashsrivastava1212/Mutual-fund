...
def _score_scheme(query_norm: str, scheme: dict[str, Any]) -> tuple[int, MatchKind | None]:
    ...
    if distinctive and distinctive.issubset(query_tokens):
...
def resolve_scheme(query: str, settings: Settings | None = None) -> SchemeMatch | None:
    ...
    for scheme in schemes:
        score, kind = _score_scheme(query_norm, scheme)
